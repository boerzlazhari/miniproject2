	...
	<div class="box box-primary">
		<div class="box-header with-border">
		    ...
		    <div class="box-tools pull-right">
				...
				<?php endif ?>
				<?php if($count >= 8): ?>
		      	<a class="btn btn-default btn-sm" href="bimbingan_kp/daftar_sidang/<?=$data_kp->id?>">
		      		<i class="fa fa-plus"></i>
		      		Pendaftaran Sidang
		      	</a>
				<?php endif ?>
		...
		<div class="box-body">
			<input type="text" class="hidden" name="base_url" id="base_url" value="<?=base_url()?>kerja_praktek/bimbingan_kp/">
			<?php if(!empty($data_kp)): ?>
				<input type="text" class="hidden" name="kp_id" id="kp_id" value="<?=$data_kp->id?>">
			<?php endif ?>
...
<script type="text/javascript">
	...
	$('.btn-simpan').click(function(){
		$.ajax({
            method   : 'POST',
            url      : base_url + 'simpan',
            data     : {kp_id : $('#kp_id').val(), catatan : $("#catatan").val()},
            success : function(){
            	$('.btn-close').click();
